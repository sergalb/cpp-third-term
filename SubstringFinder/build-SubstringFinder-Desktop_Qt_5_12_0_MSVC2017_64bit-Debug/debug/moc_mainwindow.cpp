...
QT_MOC_LITERAL(1, 12, 9), // "stop_scan"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 25), // "select_directory_and_scan"
QT_MOC_LITERAL(4, 49, 17), // "scanning_finished"
QT_MOC_LITERAL(5, 67, 4) // "stop"

    },
    "main_window\0stop_scan\0\0select_directory_and_scan\0"
    "scanning_finished\0stop"
};
...
void main_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stop_scan(); break;
        case 1: _t->select_directory_and_scan(); break;
        case 2: _t->scanning_finished(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&main_window::stop_scan)) {
                *result = 0;
                return;
            }
        }
